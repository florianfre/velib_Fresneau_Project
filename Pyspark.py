import os
os.environ["SPARK_HOME"] = "/workspaces/velib_Fresneau_Project/spark-3.2.3-bin-hadoop2.7"
os.environ['PYSPARK_SUBMIT_ARGS'] = '--jars /workspaces/velib_Fresneau_Project/spark-streaming-kafka-0-10-assembly_2.12-3.2.3.jar pyspark-shell'
